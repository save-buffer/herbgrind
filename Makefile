...
src/runtime/hg_mathreplace.h src/runtime/hg_output.h			\
src/runtime/hg_lci.h src/runtime/hg_print.h
...
src/runtime/hg_output.c src/runtime/hg_lci.c src/runtime/hg_print.c
